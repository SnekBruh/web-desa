...
@section('title', 'Tambah Profil Kepala Desa')
                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Tambah Profil Kepala Desa dan Dusun/Dukuh</h2>
    ...
    <div class="col">
        <div class="card bg-secondary shadow h-100">
            <div class="card-header bg-white border-0">
                <h3 class="mb-0">Tambah Profil Kepala Desa dan Dusun/Dukuh</h3>
            </div>
            <div class="card-body">
                <form autocomplete="off" action="{{ route('profil-kepala-desa.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
