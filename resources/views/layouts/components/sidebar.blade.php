<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(1) == 'struktur-organisasi') active @endif" href="{{ route('struktur-organisasi.index') }}">
                    <i class="fas fa-users text-danger"></i>
                    <span class="nav-link-inner--text">Kelola Struktur Organisasi</span>
                </a>
            </li>
            <li class="nav-item">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(1) == 'profil-kepala-desa') active @endif" href="{{ route('profil-kepala-desa.index') }}">
                    <i class="ni ni-single-02 text-blue"></i>
                    <span class="nav-link-inner--text">Profil Kepala Desa</span>
                </a>
            </li>
            <li class="nav-item">
