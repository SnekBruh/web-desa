        ...
        <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('update-desa', $desa) }}" method="POST">
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="visi">Visi Desa</label>
                        <input name="visi" type="text" id="visi" class="form-control form-control-alternative @error('visi') is-invalid @enderror" placeholder="Masukkan visi desa" value="{{ old('alamat_kepala_desa',$desa->visi) }}">
                        @error('visi')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="misi">Misi Desa</label>
                        <input name="misi" type="text" id="misi" class="form-control form-control-alternative @error('misi') is-invalid @enderror" placeholder="Masukkan nama desa" value="{{ old('misi',$desa->misi) }}">
                        @error('misi')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
