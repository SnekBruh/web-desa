...
<style>
    ...
    .bg-topbar {
        background-color: #000000; /* Change to the desired color code for black */
    }
...
@section('header')
<h1 class="text-white">LAYANAN SURAT</h1>
...
<form class="navbar-search text-white">
    <div class="form-group mb-0">
        <div class="input-group input-group-alternative">
            ...
            <input class="form-control text-dark" placeholder="Cari Surat ...." type="text" name="cari" id="cari" value="{{ request('cari') }}">
        </div>
    </div>
</form>
@endsection
