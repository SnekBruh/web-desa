...
Route::get('/profil-kepala-desa', 'ProfilKepalaDesaController@ProfilKepalaDesa')->name('profil-kepala-desa');
Route::get('/profil-kepala-desa/{profil_kepala_desa}/{slug}', 'ProfilKepalaDesaController@show')->name('profil-kepala-desa.show');
Route::get('/profil-kepala-desa/{profil_kepala_desa}', function (){return abort(404);});
Route::get('/struktur-organisasi', 'StrukturOrganisasiController@StrukturOrganisasi')->name('struktur-organisasi');
Route::get('/struktur-organisasi/{struktur_organisasi}/{slug}', 'StrukturOrganisasiController@show')->name('struktur-organisasi.show');
Route::get('/struktur-organisasi/{struktur_organisasi}', function (){return abort(404);});
Route::get('/visi-misi-desa', 'VisiMisiController@index')->name('visi-misi-desa');
...
Route::group(['middleware' => ['web', 'auth']], function () {
    ...
    Route::get('/kelola-profil-kepala-desa', 'ProfilKepalaDesaController@index')->name('profil-kepala-desa.index');
    Route::get('/tambah-profil-kepala-desa', 'ProfilKepalaDesaController@create')->name('profil-kepala-desa.create');
    Route::get('/edit-profil-kepala-desa/{profil_kepala_desa}', 'ProfilKepalaDesaController@edit')->name('profil-kepala-desa.edit');
    Route::resource('/profil-kepala-desa', 'ProfilKepalaDesaController')->except('create','show','index','edit');
    ...
    Route::get('/kelola-struktur-organisasi', 'StrukturOrganisasiController@index')->name('struktur-organisasi.index');
    Route::get('/tambah-struktur-organisasi', 'StrukturOrganisasiController@create')->name('struktur-organisasi.create');
    Route::get('/edit-struktur-organisasi/{struktur_organisasi}', 'StrukturOrganisasiController@edit')->name('struktur-organisasi.edit');
    Route::resource('/struktur-organisasi', 'StrukturOrganisasiController')->except('create','show','index','edit');
